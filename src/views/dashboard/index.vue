...
<template>
  <el-row :gutter="10">
    ...
    <el-col :span="8">
      <ScrollPanel style="height: 150px; padding: 4px 6px">
    ...
    <el-col :span="8">
      <ScrollPanel style="height: 350px">
        <el-table size="mini" :data="Array.from(prevMonth.operByUser).reverse()" stripe :header-cell-style="{ backgroundColor: '#efefef' }">
          <el-table-column align="center" prop="name" label="name" />
          <el-table-column align="center" prop="count" label="count" />
        </el-table>
      </ScrollPanel>
